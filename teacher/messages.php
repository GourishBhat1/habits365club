...
if (!isset($_SESSION['teacher_id']) && !isset($_COOKIE['teacher_username'])) {
...
// Fetch messages sent to this teacher, including attachments
$messages = [];
$stmt = $db->prepare("
    ...
    WHERE r.recipient_id = ? AND r.recipient_role = 'teacher'
