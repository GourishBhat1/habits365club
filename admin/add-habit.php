...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($user_id) || empty($habit_title) || empty($frequency)) {
        ...
        $insertQuery = "INSERT INTO habits (user_id, title, description, frequency, created_at) VALUES (?, ?, ?, ?, NOW())";
        $insertStmt = $db->prepare($insertQuery);
        $insertStmt->bind_param("isss", $user_id, $habit_title, $description, $frequency);
