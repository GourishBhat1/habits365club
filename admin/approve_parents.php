...
$stmt = $db->prepare("SELECT id, full_name, username, phone, location, batch_id, created_at FROM users WHERE role = 'parent' AND status = 'inactive' AND approved = 0 ORDER BY created_at DESC");
$stmt->execute();
...
<head>
    ...
    <title>Approve Parents - Habits Web App</title>
...
<div class="wrapper">
    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
            <h2 class="page-title">Approve Parent Registrations</h2>
